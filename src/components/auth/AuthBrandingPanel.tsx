...
export function AuthBrandingPanel() {
  return (
    <div className="relative flex h-full flex-col justify-between overflow-hidden bg-[#0a0f1a] p-8 lg:p-12 xl:p-16">
      ...
      >
        ...
        <motion.h1
          variants={fadeUp}
          className="mt-10 font-display text-3xl font-bold leading-tight tracking-tight text-white xl:text-4xl"
        >
          Community finance,
          <br />
        ...
        <motion.p variants={fadeUp} className="mt-4 max-w-md text-base leading-relaxed text-white/50">
      ...
      <motion.p
        ...
        className="relative mt-12 text-sm text-white/30"
      >
